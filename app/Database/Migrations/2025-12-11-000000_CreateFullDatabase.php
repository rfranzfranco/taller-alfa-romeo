...
class CreateFullDatabase extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'id_usuario' => ['type' => 'INT','constraint' => 11],
            'nombre_completo' => ['type' => 'VARCHAR','constraint' => 100],
            'ci_nit' => ['type' => 'VARCHAR','constraint' => 20],
            'telefono' => ['type' => 'VARCHAR','constraint' => 20,'null' => true],
            'correo' => ['type' => 'VARCHAR','constraint' => 100,'null' => true],
        ...
        // 3. EMPLEADOS
        $this->forge->addField([
            'id_empleado' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_usuario' => ['type' => 'INT','constraint' => 11],
            'nombre_completo' => ['type' => 'VARCHAR','constraint' => 100],
            'cargo' => ['type' => 'VARCHAR','constraint' => 50],
        ...
        // 4. VEHICULOS
        $this->forge->addField([
            'id_vehiculo' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_cliente' => ['type' => 'INT','constraint' => 11],
            'placa' => ['type' => 'VARCHAR','constraint' => 10],
            'marca' => ['type' => 'VARCHAR','constraint' => 50],
            'modelo' => ['type' => 'VARCHAR','constraint' => 50],
            'anio' => ['type' => 'INT','constraint' => 11,'null' => true],
            'tipo_motor' => ['type' => 'VARCHAR','constraint' => 50,'null' => true],
        ...
        // 5. SERVICIOS
        $this->forge->addField([
            'id_servicio' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'nombre' => ['type' => 'VARCHAR','constraint' => 100],
            'descripcion' => ['type' => 'TEXT','null' => true],
            'costo_mano_obra' => ['type' => 'DECIMAL','constraint' => '10,2'],
            'tiempo_estimado' => ['type' => 'INT','constraint' => 11,'null' => true],
            'requiere_rampa' => ['type' => 'TINYINT','constraint' => 1,'default' => 0,'null' => true],
        ]);
        ...
        // 6. INSUMOS
        $this->forge->addField([
            'id_insumo' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'codigo' => ['type' => 'VARCHAR','constraint' => 20,'null' => true],
            'nombre' => ['type' => 'VARCHAR','constraint' => 100],
            'descripcion' => ['type' => 'TEXT','null' => true],
            'precio_venta' => ['type' => 'DECIMAL','constraint' => '10,2'],
            'stock_actual' => ['type' => 'INT','constraint' => 11,'default' => 0,'null' => true],
            'stock_minimo' => ['type' => 'INT','constraint' => 11,'default' => 5,'null' => true],
        ]);
        ...
        // 7. RAMPAS
        $this->forge->addField([
            'id_rampa' => ['type' => 'INT','constraint' => 5,'unsigned' => true,'auto_increment' => true],
            'nombre' => ['type' => 'VARCHAR','constraint' => 50],
            'estado' => ['type' => 'ENUM','constraint' => ['LIBRE', 'OCUPADA', 'MANTENIMIENTO'],'default' => 'LIBRE'],
        ]);
        ...
        // 8. RESERVAS
        $this->forge->addField([
            'id_reserva' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_cliente' => ['type' => 'INT','constraint' => 11],
            'id_vehiculo' => ['type' => 'INT','constraint' => 11],
            'fecha_reserva' => ['type' => 'DATETIME'],
            'estado' => ['type' => 'ENUM','constraint' => ['PENDIENTE', 'EN_PROCESO', 'FINALIZADA', 'CANCELADA'],'default' => 'PENDIENTE','null' => true],
            'fecha_registro' => ['type' => 'TIMESTAMP','null' => true],
        ]);
        ...
        // 9. DETALLE_RESERVA
        $this->forge->addField([
            'id_detalle' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_reserva' => ['type' => 'INT','constraint' => 11],
            'id_servicio' => ['type' => 'INT','constraint' => 11],
            'id_insumo' => ['type' => 'INT','constraint' => 11,'null' => true],
            'cantidad_insumo' => ['type' => 'INT','constraint' => 11,'default' => 1,'null' => true],
            'precio_unitario_momento' => ['type' => 'DECIMAL','constraint' => '10,2','null' => true],
        ]);
        ...
        // 10. ORDENES_TRABAJO
        $this->forge->addField([
            'id_orden' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_reserva' => ['type' => 'INT','constraint' => 11],
            'id_empleado_asignado' => ['type' => 'INT','constraint' => 11],
            'id_rampa' => ['type' => 'INT','constraint' => 5,'unsigned' => true,'null' => true],
            'fecha_inicio_real' => ['type' => 'DATETIME','null' => true],
            'fecha_fin_real' => ['type' => 'DATETIME','null' => true],
            'observaciones_tecnicas' => ['type' => 'TEXT','null' => true],
            'estado' => ['type' => 'VARCHAR','constraint' => 100,'default' => 'PENDIENTE'],
        ]);
        ...
        // 11. DETALLE_INSUMOS_ORDEN
        $this->forge->addField([
            'id_detalle_insumo' => ['type' => 'INT','constraint' => 11,'unsigned' => true,'auto_increment' => true],
            'id_orden' => ['type' => 'INT','constraint' => 11],
            'id_insumo' => ['type' => 'INT','constraint' => 11],
            'cantidad' => ['type' => 'INT','constraint' => 11],
            'costo_unitario' => ['type' => 'DECIMAL','constraint' => '10,2','null' => true],
        ]);
        ...
        // 12. FACTURAS
        $this->forge->addField([
            'id_factura' => ['type' => 'INT','constraint' => 11,'auto_increment' => true],
            'id_orden' => ['type' => 'INT','constraint' => 11],
            'fecha_emision' => ['type' => 'DATETIME','null' => true],
            'monto_total' => ['type' => 'DECIMAL','constraint' => '10,2'],
            'nit_facturacion' => ['type' => 'VARCHAR','constraint' => 20,'null' => true],
            'razon_social' => ['type' => 'VARCHAR','constraint' => 100,'null' => true],
            'estado_pago' => ['type' => 'ENUM','constraint' => ['PENDIENTE', 'PAGADO', 'ANULADO'],'default' => 'PENDIENTE','null' => true],
        ]);
