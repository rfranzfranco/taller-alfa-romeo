...
<body>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Editar Servicio</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="/servicios/update/<?= $servicio['id_servicio'] ?>" method="post">
                                        <?= csrf_field() ?>
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="form-select" id="nombre" name="nombre" required
                                                    ...
                                                    <?php
                                                    $services = ['Lavado', 'Limpieza', 'Fumigado', 'Cambio de Aceite', 'Engrasado', 'Cambio de Frenos', 'Ajuste de Frenos', 'Encerado', 'Pulido'];
                                                    foreach ($services as $s): ?>
                                                        <option value="<?= $s ?>" <?= $servicio['nombre'] == $s ? 'selected' : '' ?>><?= $s ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control"
                                                    ...
                                                    value="<?= old('costo_mano_obra', $servicio['costo_mano_obra']) ?>"
                                                    required>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        ...
                                                        <?= $servicio['requiere_rampa'] == 1 ? 'checked' : '' ?>>
    ...
    <script>
        function checkRampa() {
            ...
            // Only auto-check if user changes selection, but here it's onchange.
